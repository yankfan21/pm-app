...
// server timezone.
function ProjectEvalFlow({ project, charter, riskLog, budget, scoping, tasks, taskDependencies, statusUpdates, sprints, retros, milestones, phases, onGenerated, onClose }) {
