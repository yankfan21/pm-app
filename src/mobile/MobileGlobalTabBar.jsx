...
// Root-level tab bar for /m/dashboard, /m/notifications, /m/more - replaced
// entirely by MobileProjectTabBar once the user is inside a project
// (/m/projects/:projectId/...). Never rendered alongside it.
const GLOBAL_TABS = [
  { to: '/m/dashboard', label: 'Home', icon: '◈' },
  { to: '/m/notifications', label: 'Alerts', icon: '●' },
