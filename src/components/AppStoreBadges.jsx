...
// "Coming soon" App Store / Google Play badges. Four mount points, two trees:
//
...
//
// One component rather than four copies so the muted styling and the eventual
// switch to real store links happen in one place. Sizing is per-tree, not
// here: App.css owns the desktop dimensions, mobile.css scales them down for
// phone width.
//
...
// wrap each <img> in an <a> here and all four mount points inherit it.
//
