...
// Bumped from 1200 - this function's "generate" writes 7 brief sections and
// "apply_followup" can rewrite several at once, the same ceiling that
// truncated charter's apply_followup in production (Claude's "thinking"
